...
let peanut = new Product(6, "Peanuts", 14.05, "/assets/products/Peanuts.jfif");
...
let products = [
    ...
    peanut, 
    new Product(7, "Deodorant", 6.99, "/assets/products/Deodorant.jfif"),
    new Product(8, "Mechanical Drill", 122.75, "/assets/products/Mechanical drill.jfif")
];
...
const loadProducts = () => {
    ...
    <div class="card h-100">
        ...
        product_cards += `<!-- Product price-->
                ...
                ${product.price}
                <div>
                    Quantity: <select id="product_${product.id}">
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                        <option>4</option>
